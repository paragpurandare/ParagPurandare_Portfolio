	...
	projects: [
		{
			title: "Dork-AI",
			description:
				"SaaS platform with powerful, integrated all-in-one AI tools for content creation and developers. Built with Next.js, integrated with OpenAI, Replicate AI, and Stripe.",
			image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=400",
			gradient:
				"linear-gradient(135deg, var(--aqua-primary), var(--aqua-light))",
		...
		},
		{
			title: "Nivesh Token",
			description:
				"Blockchain/Web3 crowdfunding platform for startups with automated smart contracts. Features ERC720 tokens and IPFS-based certificates for donors.",
			image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=400",
			gradient:
				"linear-gradient(135deg, var(--indigo-accent), var(--aqua-light))",
		...
		},
		{
			title: "Promptify",
			description:
				"AI-powered platform for sharing and discovering creative prompts. Built with React, Next.js, and Tailwind CSS with Next Auth integration.",
			image: "https://images.unsplash.com/photo-1551650975-87deedd944c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=400",
			gradient:
				"linear-gradient(135deg, var(--aqua-light), var(--aqua-primary))",
		...
		},
		{
			...
			description:
				"Machine learning model for predicting fraudulent transactions using Python and Kaggle datasets. Developed actionable insights for financial companies.",
		...
		},
		{
			title: "WaterWise IoT",
			description:
				"Smart water metering solution integrating IoT devices for precise consumption monitoring and streamlined billing processes.",
		...
		},
		{
			title: "Red Wine Band",
			description:
				"Official music band member and performer at VIT Pune's 'Aaroha' music club. Combining technical skills with creative musical expression.",
			...
			languages: [
				{
					...
					level: 5,
					description:
						"Native proficiency - Professional communication",
				},
				{
					name: "Hindi",
					level: 5,
					description: "Native speaker - Complete fluency",
				},
				{
					name: "Marathi",
					level: 5,
					description: "Mother tongue - Perfect command",
				},
			],
		},
	],
